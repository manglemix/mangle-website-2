<section class="flex flex-row gap-4 mt-16 flex-wrap">
	<div class="instagram-embed-box">
		<blockquote
			...
			data-instgrm-permalink="https://www.instagram.com/p/C7AqswXubJw/?utm_source=ig_embed&amp;utm_campaign=loading"
			data-instgrm-version="14"
			style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);"
		>
			<div style="padding:16px;">
				<a
					href="https://www.instagram.com/p/C7AqswXubJw/?utm_source=ig_embed&amp;utm_campaign=loading"
